...
**El juego no es nuestro.** *Twin Bee* lo publico **Konami** para MSX en 1986; su
numero de catalogo es **RC-740** y son 32 KB. Todos los derechos sobre el juego
...
El fichero `src/twinbee.asm` es el desensamblado comentado del cartucho. Se publica
...
Las imagenes que produce `tools/pantallas.py` no son ilustraciones traidas de
...
Si trabajaste en *Twin Bee* o tienes derechos sobre el juego, y preferirias que este
