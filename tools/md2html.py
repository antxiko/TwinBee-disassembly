...
# la casa, con el titulo en katakana y el 0x40 del RC-740. Creditos de personas
# no hay ninguno.
PIE = {
    "es": "<em>Twin Bee</em> lo publico Konami para MSX en 1986; su numero de catalogo es RC-740 y son 32 KB. Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Twin Bee</em> was published by Konami for the MSX in 1986; its catalogue number is RC-740 and it is 32 KB. All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
REPO = os.environ.get("TWINBEE_REPO",
                      "https://github.com/antxiko/TwinBee-disassembly")
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Twin Bee (Konami, 1986)"
