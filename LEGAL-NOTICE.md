...
**The game is not ours.** *Twin Bee* was published by **Konami** for the MSX in 1986;
its catalogue number is **RC-740** and it is 32 KB. All rights over the game
...
The file `src/twinbee.asm` is the commented disassembly of the cartridge. It is
...
The pictures produced by `tools/pantallas.py` are not illustrations brought in
...
If you worked on *Twin Bee* or hold rights over the game, and you would rather this
